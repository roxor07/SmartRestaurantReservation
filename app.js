...
module.exports = (config) => {
  ...
  app.use(logger("dev"));
  app.use("/bots/slack", slackRouter({ reservationService, config, witService, sessionService }));
  ...
  app.use("/bots/alexa", alexaRouter({ reservationService, config, witService, sessionService }));
